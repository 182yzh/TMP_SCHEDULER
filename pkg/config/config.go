...
type poseidonConfig struct {
    ...
    SchedulingGPU      bool    `json:"schedulingGPU,omitempty"`
	EnablePriority     bool    `json:"disablePriority,omitempty"`
	EnableTaskResNeed  bool	   `json:"disableTaskResNeed,omitempty"`
	EnableResAvai      bool    `json:"disableResAvai,omitempty"`
	EnableRunTime      bool    `json:"disableRunTime,omitempty"`
	FlowDebug          bool    `json:"debugmode,omitempty"`
}

// GetSchedulingGPU returns whether scheduling by GPU from config
func GetSchedulingGPU() bool {
    return config.SchedulingGPU
}

func GetFlowDebug()bool{
	return config.FlowDebug
}
...
func GetEnableTaskResNeed() bool {
    return config.EnableTaskResNeed
}

func GetEnableResAvai() bool {
    return config.EnableResAvai
}

func GetEnableRunTime() bool {
    return config.EnableRunTime
}
...
func ReadFromCommandLineFlags() {
	pflag.StringVar(&config.SchedulerName, "schedulerName", "poseidongpu", "The scheduler name with which pods are labeled")
	...
	pflag.BoolVar(&config.SchedulingGPU, "schedulingGPU", false, "Disable/Enable GPU scheduling of Poseidon")
	pflag.BoolVar(&config.EnablePriority, "enablePriority", true, "Disable/Enable Scheduling Policy Priority")
	pflag.BoolVar(&config.EnableTaskResNeed, "enableTaskResNeed", true, "Disable/Enable Scheduling Policy TaskResNeed")
	pflag.BoolVar(&config.EnableResAvai, "enableResAvai", true, "Disable/Enable Scheduling Policy ResAvai")
	pflag.BoolVar(&config.EnableRunTime, "enableRunTime", true, "Disable/Enable Scheduling Policy RunTime")
	pflag.BoolVar(&config.FlowDebug, "flowDebug", false, "set this to output scheduling detail")
